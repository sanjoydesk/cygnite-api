...
<div id="main_container">
    ...
    <div class="logo"><a href="#"><img src="images/logo.gif" alt="" title="" border="0" /></a></div>
         ...
         <form action="?action=submit" method="post" class="niceform">
    ...
    <div class="footer_login">
    	...
    	<div class="left_footer_login">IN ADMIN PANEL | Powered by <a href="#">Spark</a></div>
    	<div class="right_footer_login"><a href="#"><img src="templates/sources/images/indeziner_logo.gif" alt="" title="" border="0" /></a></div>
